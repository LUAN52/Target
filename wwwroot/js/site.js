...
var categoryC =document.querySelector("categoryId")
var categoryError =document.querySelector("categoryErrorId")
...
button.addEventListener("click", function (e) {
    ...
    if((price.value=="")||(nameC.value=="")||(categoryC.value==""))
    {
        e.preventDefault();
        ...
        if(categoryC.value=="")
        {
            categoryError.innerHTML =" nao pode deixar a categoria em branco"
        }
    }
        ...
        if( !typeof categoryC.value=="string")
        {    e.preventDefault()
            errorName.innerHTML = "digite uma Categoria valida"
        }
